...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Generate Markdown files for Python files with mkdocstrings directives.')
    parser.add_argument('--input_dir', type=str, default='.', help='Input directory containing Python files (default: current directory)')
    parser.add_argument('--output_dir', type=str, default='.', help='Output directory for generated Markdown files (default: current directory)')
